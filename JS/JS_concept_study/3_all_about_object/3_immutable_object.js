...
console.log(jisoo2);    // 프로퍼티가 추가되지 않았음을 확인할 수 있음

delete jisoo2['name'];  // Extensible과 다르게 Seal은 삭제도 되지 않음을 확인할 수 있음
console.log(jisoo2);
 ...
 * - 기본 값 : false
 * - 프로퍼티 추가, 삭제도 안될 뿐더러, Object.defineProperty를 통한 값 변경도 불가능
