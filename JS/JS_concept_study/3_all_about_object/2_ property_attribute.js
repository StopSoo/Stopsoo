...
// 프로퍼티 애트리뷰트까지 함께 정의하고 싶다면 다음과 같이 할 수 있다.
...
jisoo2.height = 180;
console.log(jisoo2);    // writable: true -> 값 변경 가능 
...
// 프로퍼티 애트리뷰트 중 enumerable를 false로 바꾼다면 다음 코드에서 해당 프로퍼티가 출력되지 않는다.
...
// configurable을 false로 변경하여 아래 enumerable 프로퍼티 변경이 불가능하다. 
// Object.defineProperty(jisoo2, 'height', {
//     enumerable: false,
// });
